...
function the_postPDFLink($post) {
    //printf($post->ID);
    if(get_post_meta($post->ID, 'PostPDFLink', true)!=""){
        
        
    //printf(get_post_meta($post->ID, 'PostPDFLink', true));
        printf('<a target="_blank" href="' . get_post_meta($post->ID, 'PostPDFLink', true) . '" rel="bookmark">Download post a pdf</a>');
        }
}
/**
