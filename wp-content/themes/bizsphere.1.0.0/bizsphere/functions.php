...
function BizSphere_scripts() {
	...
	//wp_enqueue_style( 'BizSphere-font-opensans', '//fonts.googleapis.com/css?family=Open+Sans&subset=latin,latin-ext,cyrillic-ext,greek-ext,cyrillic,greek,vietnamese' );
	
	//wp_enqueue_style( 'BizSphere-font-titillium', '//fonts.googleapis.com/css?family=Titillium+Web:600&subset=latin,latin-ext' );	

	//wp_enqueue_script( 'BizSphere-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
